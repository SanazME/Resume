...
\name{Sanaz}{Arabzadeh Esfarjani}
\address{8 Dexter St., Unit 2, Medford, MA}
\mobile{857-266-3661}
...
\position{Senior Software Engineer{\enskip\cdotp\enskip}Physical Modeling} % Your expertise/fields
%\quote{``"} % A quote or statement

\makecvfooter{\today}{Sanaz A. Esfarjani~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/onlinecourses.tex}
