...
\section{\textbf{Skills}}
      ...
      \cvlistdoubleitem{ Dev Ops (CI/CD, AWS CDK, AWS Cloudformation, Jenkins)}
                       { Observability (Cloudwatch, Datadog, Splunk)}
      \cvlistdoubleitem{HTTP APIs (REST, GraphQL, Auth)}
                       { Web Dev (React, TS/JS)}
...
%\subsection{\textbf{Languages}}
  ...
  \cvline{Languages:}{Typescript, Python, Javascript (Node.js), Go(learning)}


\section{\textbf{Experience}}

\cventry{Dec 2019 - Present}{\textbf{Senior Software Engineer}}{Liberty Mutual Insurance}{}{Boston, MA}
