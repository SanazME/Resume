...
\section{\textbf{Skills}}
      ...
      \cvlistdoubleitem{ Software Architecture and Design}
                       { Cloud (AWS: Lambda, DynamoDB, API Gateway, AppSync; Kubernetes)}
      \cvlistdoubleitem{ Dev Ops (CI/CD, AWS CDK, AWS Cloudformation, Jenkins, Docker/Containerization)}
                       { Observability (Cloudwatch, Datadog, Splunk)}
      \cvlistdoubleitem{ Distributed Systems}
                       { HTTP APIs (REST, GraphQL, Auth)}
      \cvlistdoubleitem{ Web Dev (React)}
